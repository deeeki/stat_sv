...
Period.find_or_create_by(card_set_code: :bos, sequence: 2, started_on: Date.new(2018, 7, 18), ended_on: Date.new(2018, 8, 19))
#Period.find_or_create_by(card_set_code: :bos, sequence: 3, started_on: Date.new(2018, 8, 20), ended_on: Date.new(2018, 9, 26))
